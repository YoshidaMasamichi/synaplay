...
class _RecruitmentListPageState extends State<RecruitmentListPage> {
  ...
  Widget build(BuildContext context) {
    final displayName = supabase.auth.currentUser
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          TextButton(
                              onPressed: _reload, child: const Text('再試行')),
                        ],
                      ),
                    );
                  }
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text('まだ募集がありません',
                              style: TextStyle(
                                  color: AppColors.textSub, fontSize: 15)),
                          const SizedBox(height: 8),
                          const Text('右下のボタンから最初の募集を作ってみましょう',
                              style: TextStyle(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async {
          final created = await Navigator.push<bool>(
            context,
            MaterialPageRoute(
                builder: (_) => const CreateRecruitmentPage()),
          );
          if (created == true) _reload();
        },
        backgroundColor: AppColors.primary,
        icon: const Icon(Icons.add),
        label: const Text('募集を作る',
...
class _RecruitmentCard extends StatelessWidget {
  ...
  const _RecruitmentCard(
      {required this.recruitment, required this.formatDate});
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text(formatDate(recruitment.date),
                  style: const TextStyle(
              ...
              const Icon(Icons.people_outline,
                  size: 14, color: AppColors.textSub),
              const SizedBox(width: 4),
              Text('定員 ${recruitment.maxPlayers} 人',
                  style: const TextStyle(
                      fontSize: 13, color: AppColors.textSub)),
              const Spacer(),
              Text(
